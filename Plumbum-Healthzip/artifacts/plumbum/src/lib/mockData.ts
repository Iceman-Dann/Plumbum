// ---------------------------------------------------------------------------
// mockData.ts — All static/mock data in one place.
// Swap the `neighborhoods` address lists for real API outputs when ready.
// ---------------------------------------------------------------------------
...
export const mockCities: CityConfig[] = [
  {
    slug: "newark",
    name: "Newark",
    state: "NJ",
...
// ---------------------------------------------------------------------------
// Methodology content (mock — swap for CMS or markdown loader)
// ---------------------------------------------------------------------------

export const mockMethodology = [
  {
    id: "introduction",
    title: "Introduction",
    content:
  ...
  },
  {
    ...
    title: "Data Sources",
    table: [
      { source: "American Community Survey", publisher: "US Census Bureau", year: "2022", fields: "Year structure built, poverty rate", link: "#" },
      { source: "Safe Drinking Water Information System", publisher: "EPA", year: "2023", fields: "Lead action level exceedances", link: "#" },
      { source: "National Parcel Data", publisher: "Various Counties", year: "2023", fields: "Lot age, zoning type", link: "#" },
      { source: "LSL Inventories", publisher: "State DEPs", year: "2024", fields: "Known pipe materials", link: "#" },
    ],
  },
  {
    id: "model",
